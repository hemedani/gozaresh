# Gozarish Backend - Deno Application
(adapted from Naghshe backend)

## Project Overview
Gozarish backend is a Deno + Lesan application for a citizen report system. Models include User, Report (with title, description, attachments, tags, location, status, etc.), File, Tag, and any required extra models.
