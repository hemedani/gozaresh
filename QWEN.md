# Gozarish - Full-Stack Application

## Project Overview
Gozarish is a full-stack web application built with a Deno backend and Next.js frontend. It is a citizen report registration system that allows ordinary people to securely log in and submit reports containing title, attachments, description, tags, location, and additional minor fields. The application features a simple multi-language report page and an advanced admin panel for managing reports and users.
