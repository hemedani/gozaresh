...
- ✅ Admin Reports Management data table, filters, search, pagination, and row actions (`/admin/reports`)
...
1. Add sorting and bulk actions to the Reports management table (`/admin/reports`)
