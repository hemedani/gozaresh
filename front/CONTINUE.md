...
- ✅ Admin Reports Management basic data table and row actions (`/admin/reports`)
...
1. Add filtering, search, and pagination to the Reports management table (`/admin/reports`)
